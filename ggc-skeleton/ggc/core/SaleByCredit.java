...
public class SaleByCredit extends Sale implements Serializable {
    ...
    public String toString() {
        ...
        String message = "VENDA|" + super.getId() + "|" + super.getPartner().getKey() + "|" + super.getProduct().getId()
                + "|" + super.getQuantity() + "|" + Math.round(getBaseValue()) + "|"
                + Math.round(super.getValueToBePaid()) + "|" + super.getTransactionDate().getDeadlinePayment();
        if (isPaid())
